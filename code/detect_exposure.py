...
# 401亮度閥值
WL_401_BACKGROUND_THRESHOLD = 0.1568
WL_401_GRAY_THRESHOLD = 0.1424

# 403亮度閥值
WL_403_BACKGROUND_THRESHOLD = 0.0464
WL_403_GRAY_THRESHOLD = 0.1024

# 資產負債表亮度閥值
WL_BS_BACKGROUND_THRESHOLD = 0.1568
WL_BS_GRAY_THRESHOLD = 0.1424

# 損益及稅額計算表亮度閥值
WL_IS_BACKGROUND_THRESHOLD = 0.016
WL_IS_GRAY_THRESHOLD = 0.0368
